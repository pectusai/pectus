/**
 * provision.ts — workspace-level GA4 setup.
 *
 * Stub in v1. Real implementation lands in PR6.
 *
 * Called by `npx pectus connect ga4 --workspace <code>` to:
 ...
 *   3. Write the property_id into the `integrations` table for the workspace.
