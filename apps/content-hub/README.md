# content-hub — Astro public site (pre-installed app)

The public-facing content hub. Ships pre-installed so a brand new Pectus user gets something visual to point at within minutes of running the install. Static output, perfect SEO/AEO/GEO out of the box, built from your Pectus articles.
