...
import { templates } from "@pectus/content-hub/templates";
...
export default async function CreatePage({
  ...
  if (!nodeId) {
     ...
     * already added. */
    redirect(`/projects/${code}/apps/content-hub/pages`);
  }
  ...
  if (existing) {
    ...
    const { data: variant } = await supabase
      ...
      .maybeSingle();
    if (variant) {
      redirect(`/projects/${code}/apps/content-hub/pages/builder/${variant.id}`);
    }
  }
