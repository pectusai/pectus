          ...
          <thead className="bg-zinc-50 text-xs uppercase tracking-wide text-zinc-500">
            <tr>
              <th className="px-4 py-2 text-left">
                <a
                  href={`/projects/${code}/apps/content-hub/settings/redirects?sort=from_path`}
              ...
              <th className="px-4 py-2 text-left">
                <a
                  href={`/projects/${code}/apps/content-hub/settings/redirects?sort=to_path`}
                  className="hover:text-zinc-900"
              ...
              <th className="px-4 py-2 text-left">
                <a
                  href={`/projects/${code}/apps/content-hub/settings/redirects?sort=status`}
                  className="hover:text-zinc-900"
              ...
              <th className="px-4 py-2 text-left">
                <a
                  href={`/projects/${code}/apps/content-hub/settings/redirects?sort=source`}
                  className="hover:text-zinc-900"
