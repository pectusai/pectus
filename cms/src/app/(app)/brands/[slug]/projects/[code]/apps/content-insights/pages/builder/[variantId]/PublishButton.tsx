    ...
    return (
      <div className="max-w-[24rem] rounded-md border border-amber-200 bg-amber-50 p-3 text-right text-xs text-amber-900">
        ...
        <p className="mt-1 text-amber-800">
          Set <code>content_insights_repo</code> under{" "}
          <Link
            href={`/projects/${projectCode}/apps/content-insights/settings/site-url`}
            className="underline"
          >
            Site URL settings
          </Link>{" "}
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        title={
          isPublished
            ? "Republish this variant: builds the page JSON, regenerates the site-plan and redirects, and commits to your content-insights repo."
            : "Publish this variant: writes content/pages/<locale>/<slug>.json (and refreshes site-plan + redirects) to your content-insights repo. Vercel auto-deploys."
        }
      >
        {pending
          ? "Publishing…"
