  ...
  return (
    <form action={formAction} className="mt-5 space-y-3">
      ...
      <p className="text-[11px] text-zinc-500">
        Pectus stores the JSON in the <code>integrations</code> table in your
        Supabase. It never leaves your install.
      </p>
...
export function Ga4PropertyForm({
  ...
  return (
    <form action={formAction} className="mt-4 space-y-3">
      ...
      />
      <FeedbackBlock state={state} />
      <Submit pendingLabel="Testing + saving…">
...
export function GscSiteForm({ defaultSiteUrl }: { defaultSiteUrl: string }) {
