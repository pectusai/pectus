    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-600">
          The full redirect map for this workspace. Mirrored to{" "}
          ...
          <thead className="bg-zinc-50 text-xs uppercase tracking-wide text-zinc-500">
            <tr>
              <th className="px-4 py-2 text-left">
                <a
                  href={`/workspaces/${code}/settings/redirects?sort=from_path`}
              ...
              <th className="px-4 py-2 text-left">
                <a
                  href={`/workspaces/${code}/settings/redirects?sort=to_path`}
                  className="hover:text-zinc-900"
              ...
              <th className="px-4 py-2 text-left">
                <a
                  href={`/workspaces/${code}/settings/redirects?sort=status`}
                  className="hover:text-zinc-900"
              ...
              <th className="px-4 py-2 text-left">
                <a
                  href={`/workspaces/${code}/settings/redirects?sort=source`}
                  className="hover:text-zinc-900"
